<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            ...
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                ...
                <p style="margin: 0;"> Your Case has been enetered successfully. Your Case Number is <b> {{ $details['case_number'] }} </b> </p>
                <p style="margin: 0; font-size: 16px;">
                    Please always note that this case number will be used to track your case. Save it or Write it down somewhere where you cannot forget it.
                </p>
            </td>
            </tr>
            <tr>
    ...
    <tr>
        <td bgcolor="#ee4c50" style="padding: 30px 30px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            <tr>
            <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;"><p style="margin: 0;">&reg; LawFirmX<br />
            </p></td>
            <td align="right">
